...
/// (0, N) is add-ons. There is no type column, and adding one would be a second
/// answer to a question the pair already answers.
...
export const api = {
  ...
  /// Every option group on a dish — sizes and add-ons alike — in rank order
  /// (migration 0106).
  ...
  /// not a detail: sending only one group deletes the rest. Read with
  /// `menuItemOptions`, change what you mean to change, send the whole list back.
