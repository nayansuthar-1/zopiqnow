...
///
/// The checklist itself lives in `../checklist`, because the wizard's step bar
/// ticks off the same rule — see the reasoning there. This screen is where it is
/// read line by line, and the only screen that can act on it.
///
/// **It loads the menu itself rather than taking the wizard's copy.** The bar's
/// ticks are advice; this is the page with the Publish button on it, and the
/// checklist behind that button has to be what the database will see a moment
/// later, not what was true when the wizard mounted.
