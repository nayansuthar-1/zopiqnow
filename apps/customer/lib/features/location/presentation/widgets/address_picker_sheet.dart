...
class _AddressPickerSheetState extends ConsumerState<AddressPickerSheet> {
  ...
  Future<void> _useCurrentLocation() async {
    // Turns location services on, shows Play's prominent disclosure, or offers
    // app settings — whichever this device actually needs, in that order. It
    // used to be the disclosure alone, and everything else came back as an
    // error message describing a switch the sheet gave you no way to reach.
    //
    // Declining is an answer, not a failure: nothing is shown, because the
    // customer did not fail to give us a location — they said no, and the
    // saved-address list below still works.
